 ...
 return (
   ...
   >
     <div className="max-w-4xl mx-auto">
       <h1
         ref={titleRef}
         className="text-3xl font-bold text-purple-800 dark:text-purple-300 mb-8"
       >
         Settings
       </h1>
       ...
       <div ref={cardsRef} className="grid grid-cols-1 gap-6">
         ...
         <div className="bg-white/70 dark:bg-gray-700/70 backdrop-blur-lg rounded-xl shadow-md p-6 border border-white/30 dark:border-gray-600/30">
           <div className="flex items-center mb-4">
             <FaBell className="text-purple-500 dark:text-purple-400 mr-3" />
         ...
         <div className="bg-white/70 dark:bg-gray-700/70 backdrop-blur-lg rounded-xl shadow-md p-6 border border-white/30 dark:border-gray-600/30">
           <div className="flex items-center mb-4">
             <FaMoon className="text-purple-500 dark:text-purple-400 mr-3" />
             <h2 className="text-xl font-semibold text-purple-800 dark:text-purple-200">
               Dark Mode
             </h2>
           </div>
         ...
         <div className="bg-white/70 dark:bg-gray-700/70 backdrop-blur-lg rounded-xl shadow-md p-6 border border-white/30 dark:border-gray-600/30">
           <div className="flex items-center mb-4">
             <FaFont className="text-purple-500 dark:text-purple-400 mr-3" />
             <h2 className="text-xl font-semibold text-purple-800 dark:text-purple-200">
               Bible Version
             </h2>
           </div>
           ...
           <select
             ...
             className="bg-white/80 dark:bg-gray-600/80 border border-gray-300 dark:border-gray-500 text-gray-900 dark:text-gray-100 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5"
           >
         ...
         <div className="bg-white/70 dark:bg-gray-700/70 backdrop-blur-lg rounded-xl shadow-md p-6 border border-white/30 dark:border-gray-600/30">
           <div className="flex items-center mb-4">
             <FaPalette className="text-purple-500 dark:text-purple-400 mr-3" />
             <h2 className="text-xl font-semibold text-purple-800 dark:text-purple-200">
               Theme Color
             </h2>
           </div>
